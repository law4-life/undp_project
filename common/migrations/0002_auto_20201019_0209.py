...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='comment',
            name='account',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='account_comments', to='dbms.account'),
        ),
        migrations.AddField(
            model_name='comment',
            name='commented_by',
        ...
        migrations.AddField(
            ...
            name='account',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='account_attachment', to='dbms.account'),
        ),
        migrations.AddField(
            model_name='attachments',
            name='contact',
