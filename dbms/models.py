...
class Account(models.Model):
    ...
    accounttype = models.CharField(
        _("Account Type"), max_length=255, choices=TYPECHOICES, blank=True, null=True
    )
    employees = models.IntegerField(_("Number of Employees"),blank=False, null=False
    )
    ...
    billing_city = models.CharField(
        _("City"), max_length=255, choices=TOWNS, blank=True, null=True)
...
#Change the below to return Full name instead of username
    @property
